...
<header class="w-full py-4 px-12 flex flex-row justify-center shadow-gray-400 shadow-md fixed top-0 right-0 left-0 bg-white z-[1]">
  <div class="logo flex flex-col items-center justify-center gap-1">
    <div class="max-w-16 sm:max-w-10">
      <img src={pixiepad} alt="pixierush logo" />
    </div>
    <h1 class="text-lg sm:text-xs">pIxIerush.Id</h1>
  </div>
</header>
...
<div class="h-screen flex bg-black"></div>
